import { HistoricalPriceType, StockDetails, StockFullNameType, StocksType } from '../models';
...
export const historicalPrices: HistoricalPriceType = {
  AAPL: [150.25, 151.25, 152.25, 153.25, 154.25, 155.25, 156.25, 157.25, 158.25, 159.25],
  GOOGL: [2800.1, 2820.1, 2840.1, 2860.1, 2880.1, 2900.1, 2920.1, 2940.1, 2960.1, 2980.1],
  MSFT: [305, 308, 311, 314, 317, 320, 323, 326, 329, 332],
  AMZN: [3400.5, 3380.5, 3360.5, 3340.5, 3320.5, 3300.5, 3280.5, 3260.5, 3240.5, 3220.5],
  ...
  NFLX: [580.75, 577.75, 574.75, 571.75, 568.75, 565.75, 562.75, 559.75, 556.75, 553.75],
  ...
  SHOP: [1450.4, 1440.4, 1430.4, 1420.4, 1410.4, 1400.4, 1390.4, 1380.4, 1370.4, 1360.4],
